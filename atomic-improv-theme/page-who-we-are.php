    ...
    <div class="container">
      <div class="content-flex">
        ...
        <div class="flex-item">
          ...
          <p>Atomic Improv has performed all over the world, starting as local legends at Edmonton’s Sidetrack Café to
            headlining at Montreal's “Just for Laughs” festival and San Francisco Comedy Festival, hosting the red
            carpet
            at
            the Junos and preforming at the 2012 London Summer Olympics.</p>
        </div>
        <div class="flex-item">
          <!-- icons -->
          <div class="icon-flex">
        ...
        <div class="flex-item">
          <p>They also boast several awards, such as Variety Act of the Year, and Comedy Act of the Year for both 1994
            and
            1995 by the Canadian Organization of Campus Activities, several Alberta Motion Picture Association Awards,
            and
            Canadian Comedy Awards.
          </p>
          <p>Atomic Improv also bring their talents over to the corporate sector entertaining and educating as hosts,
            keynote speakers and with their incredible Power of Yes workshops that help teach employees to reach their
            full
            potential.</p>
        </div>
      ...
      <div class="content-flex">
        ...
        <div class="flex-item item-3">
          ...
          <p>For fourteen years, from 2003 to 2017, Donovan graced the airwaves with his wit and humor on the CBC Radio
            One
            series, "The Irrelevant Show,” as a performer and writer, leaving an indelible mark on listeners across the
            nation.
          </p>
          <p>
            He has also shared the screen with Tim Curry, Demi Moore, Patrick Swayze, Carmen Electra, Tom Green, Donald
            and
            Keifer Sutherland, appeared on Amazing Race Canada, as well as several commercials for the Alberta Motor
            Association and Volvo Canada.
