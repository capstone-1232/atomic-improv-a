...
<main id="primary" class="site-main">
    <section class="santa">
        ...
        <img src="http://atomic-improv-a.web.dmitcapstone.ca/wp-content/themes/atomic-improv-theme/images/tfs-dogs-sm.webp"
            alt="santa with 2 black dogs">
    ...
    <section>
        ...
        <div>
            ...
            <p>@thatfunnysanta can often be found visiting Banff at the Fairmont Banff Springs Hotel where he brings
                holiday cheers to guest and visitors alike. </p>
            <img src="http://atomic-improv-a.web.dmitcapstone.ca/wp-content/themes/atomic-improv-theme/images/tfs-mountain-sm.webp"
                alt="Santa and Mrs. Claus greeting a crowd"><img
                src="http://atomic-improv-a.web.dmitcapstone.ca/wp-content/themes/atomic-improv-theme/images/tfs-banff-sm.webp"
                alt="Santa speaking on stage">
        </div>
        <div>
