...
<main id="primary" class="site-main">
        ...
        <div class="hero-banner">
            ...
            if ($thatfunnysanta_hero_query->have_posts()):
                while ($thatfunnysanta_hero_query->have_posts()):
                    ...
                    ?>
                    <!-- hero banner -->
                    <div class="hero-section" style="background-image: url('<?php echo $thatfunnysanta_hero_url; ?>');">
                        <h1 class="hero-title">That Funny Santa</h1>
    ...
    <section>
        ...
        <div>
            ...
            <img src="http://atomic-improv-a.web.dmitcapstone.ca/wp-content/themes/atomic-improv-theme/images/tfs-banff-sm.webp"
